...
| Operatividad | Pestaña **«🩺 Operatividad»**: tablero que responde en una mirada «¿en qué está cada equipo?» — lista los equipos que requieren atención (no operativos, en servicio técnico, con expediente abierto o FS/NU en planilla sin resolución posterior) con su **último estado, última gestión con fecha y días transcurridos**, ordenados por criticidad y con acceso directo a la ficha. |
