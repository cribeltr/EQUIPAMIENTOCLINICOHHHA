...
| 9 | Formulario de Pendientes: fecha de compromiso con atajos (Hoy / 3 días / 1 semana), tipo de pendiente, descripción, lista de tareas, Responsable Administrativo (por defecto Cristián Beltrán Oviedo), Responsable Ejecutivo y bitácora de **gestión asociada**. Las tareas de **protocolo** se marcan con uno de cuatro estados — **Sí / No / Imprimir / Gestión** — y admiten **comentarios y actualizaciones** propios (con fecha); el contador «resueltas / total» cuenta como resueltas las que tienen respuesta definitiva (Sí/No). Se pueden trabajar tanto desde el formulario como desde la fila desplegable de la bandeja. Al elegir el **tipo de pendiente «Protocolo Interno de Mantenimiento» o «Protocolo Externo de Mantenimiento»** (o al abrir un pendiente que ya lo tenga) la app **arma automáticamente la lista de protocolo correspondiente**, de modo que también puede añadirse a un pendiente existente. El texto escrito en «Nueva tarea» o «Nueva gestión» que aún no se haya agregado se **incorpora al guardar** para no perderlo. Vista global de pendientes (abiertos / vencidos / completados). |
